...
def analisador(produto):
    prompt_sistema = f"""
        Você é um analisador de sentimentos de avaliações de produtos.
        Escreva um parágrafo com até 50 palavras resumindos as avaliações e depois atribua qual o sentimento geral para o produto.
    ...
    """
    prompt_usuario = carrega(f"dados\_avaliacao-{produto}.txt")
